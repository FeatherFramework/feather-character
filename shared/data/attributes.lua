CharacterConfig.Attributes.ColorPalettes = {
    eyebrows = {
        0x3F6E70FF, -- black
        0x0105607B, -- grey
        0x17CBCC83, -- red
...
CharacterConfig.Attributes.OverlaysInfo = {
    eyebrows     = {
...
CharacterConfig.Attributes.OverlayLookup = {
    eyeliners = {
        label = 'Eyeliners',
...
CharacterConfig.Attributes.Makeup = {
    eyeliners = {
        { id = 0x29A2E58F, albedo = 0xA952BF75, ma = 0xDD55AF2A, },
    },
    lipsticks = {
...
CharacterConfig.Attributes.OverlayAllLayers = {
    eyeliners = {
        name = 'eyeliners',
        visibility = 0,
        tx_id = 1,
