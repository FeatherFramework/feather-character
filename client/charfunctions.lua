...
function CreateNewCharacter()
    ...
    Wait(500)
    local obj = feather.Object:Create('p_package09', Config.SpawnCoords.gotocoords.x, Config.SpawnCoords.gotocoords.y,
    ...
    DoScreenFadeIn(1000)
    SetFocusEntity(tobj)
    StartCam(Config.CameraCoords.creation.x,Config.CameraCoords.creation.y,Config.CameraCoords.creation.z,Config.CameraCoords.creation.h,Config.CameraCoords.creation.zoom)
    ToggleUIState()
end
