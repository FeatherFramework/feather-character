function OpenFoundationMakeupPage(parentMakeupPage)
    local k, v = 'foundation', 'foundation'
    ...
    activeMakeupPage:RegisterElement('slider',
        { label = v .. " " .. FeatherCore.Locale.translate(0, "opacity"), start = 1, min = 0, max = 1, steps = 0.1 },
        function(data)
    ...
    activeMakeupPage:RegisterElement("toggle", { label = v, start = false }, function(data)
        if data.value then
            ActiveTexture[v] = 1
    ...
    -- foundation: only color1
    activeMakeupPage:RegisterElement('slider',
        { label = v .. ' ' .. FeatherCore.Locale.translate(0, "color1"), start = 1, min = 1, max = 254, steps = 1 },
        function(data)
