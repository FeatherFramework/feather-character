-- creationmenu/makeup/eyeliners.lua

function OpenEyelinerMakeupPage(parentMakeupPage)
    local k, v = 'eyeliners', 'eyeliners'
    ...
    activeMakeupPage:RegisterElement('slider', {
        ...
        ChangeOverlay(PlayerPedId(), v, vis, ActiveTexture[v], 0, 0, tx_color_type, 1.0, 0, 1, ActiveColor1[v],
            ActiveColor2[v], ActiveColor3[v], ActiveVariant[v], ActiveOpacity[v],
            SelectedAttributeElements['Albedo'].hash)
